...
mixin _$StudentProfile {
 ...
 String get id;@JsonKey(name: 'full_name') String get fullName; String get nationality;@JsonKey(name: 'birth_date', fromJson: _dateFromJson, toJson: _dateToJson) DateTime? get birthDate; String? get gender; String get region; String? get province;@JsonKey(name: 'city_municipality') String? get cityMunicipality; double get gpa;@JsonKey(name: 'year_level') int get yearLevel; String get course; String? get school;@JsonKey(name: 'monthly_family_income') double? get monthlyFamilyIncome;@JsonKey(name: 'has_disability') bool get hasDisability;@JsonKey(name: 'is_indigenous') bool get isIndigenous;@JsonKey(name: 'setup_complete') bool get setupComplete;@JsonKey(name: 'role') String get role;@JsonKey(name: 'email') String? get email;@JsonKey(name: 'status') String get status;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,fullName,nationality,birthDate,gender,region,province,cityMunicipality,gpa,yearLevel,course,school,monthlyFamilyIncome,hasDisability,isIndigenous,setupComplete,role,email,status,createdAt,updatedAt]);

@override
String toString() {
  return 'StudentProfile(id: $id, fullName: $fullName, nationality: $nationality, birthDate: $birthDate, gender: $gender, region: $region, province: $province, cityMunicipality: $cityMunicipality, gpa: $gpa, yearLevel: $yearLevel, course: $course, school: $school, monthlyFamilyIncome: $monthlyFamilyIncome, hasDisability: $hasDisability, isIndigenous: $isIndigenous, setupComplete: $setupComplete, role: $role, email: $email, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'full_name') String fullName, String nationality,@JsonKey(name: 'birth_date', fromJson: _dateFromJson, toJson: _dateToJson) DateTime? birthDate, String? gender, String region, String? province,@JsonKey(name: 'city_municipality') String? cityMunicipality, double gpa,@JsonKey(name: 'year_level') int yearLevel, String course, String? school,@JsonKey(name: 'monthly_family_income') double? monthlyFamilyIncome,@JsonKey(name: 'has_disability') bool hasDisability,@JsonKey(name: 'is_indigenous') bool isIndigenous,@JsonKey(name: 'setup_complete') bool setupComplete,@JsonKey(name: 'role') String role,@JsonKey(name: 'email') String? email,@JsonKey(name: 'status') String status,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of StudentProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? nationality = null,Object? birthDate = freezed,Object? gender = freezed,Object? region = null,Object? province = freezed,Object? cityMunicipality = freezed,Object? gpa = null,Object? yearLevel = null,Object? course = null,Object? school = freezed,Object? monthlyFamilyIncome = freezed,Object? hasDisability = null,Object? isIndigenous = null,Object? setupComplete = null,Object? role = null,Object? email = freezed,Object? status = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
class _StudentProfile extends StudentProfile {
  const _StudentProfile({required this.id, @JsonKey(name: 'full_name') this.fullName = '', this.nationality = 'Filipino', @JsonKey(name: 'birth_date', fromJson: _dateFromJson, toJson: _dateToJson) this.birthDate, this.gender, this.region = '', this.province, @JsonKey(name: 'city_municipality') this.cityMunicipality, this.gpa = 0.0, @JsonKey(name: 'year_level') this.yearLevel = 1, this.course = '', this.school, @JsonKey(name: 'monthly_family_income') this.monthlyFamilyIncome, @JsonKey(name: 'has_disability') this.hasDisability = false, @JsonKey(name: 'is_indigenous') this.isIndigenous = false, @JsonKey(name: 'setup_complete') this.setupComplete = false, @JsonKey(name: 'role') this.role = 'student', @JsonKey(name: 'email') this.email, @JsonKey(name: 'status') this.status = 'active', @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt}): super._();
