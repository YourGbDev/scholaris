...
ThemeData scholarisTheme() {
  ...
  return ThemeData(
    ...
    textTheme: TextTheme(
      displayLarge: outfit(fontSize: 36, fontWeight: FontWeight.w700, letterSpacing: -0.5),
      headlineLarge: outfit(fontSize: 28, fontWeight: FontWeight.w700, letterSpacing: -0.4),
      headlineMedium: outfit(fontSize: 22, fontWeight: FontWeight.w600, letterSpacing: -0.2),
      headlineSmall: outfit(fontSize: 18, fontWeight: FontWeight.w600, letterSpacing: -0.2),
      ...
      bodySmall: openSans(fontSize: 12, fontWeight: FontWeight.w400, letterSpacing: 0.15),
      labelLarge: outfit(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0),
      labelMedium: outfit(fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: 0.15),
      labelSmall: outfit(fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.2),
    ),
    appBarTheme: AppBarTheme(
      backgroundColor: kSurfaceContainerLowest,
      elevation: 0,
      centerTitle: false,
      titleTextStyle: outfit(fontSize: 18, fontWeight: FontWeight.w700, color: kOnSurface, letterSpacing: -0.2),
    ...
    snackBarTheme: SnackBarThemeData(
      ...
      contentTextStyle: openSans(color: Colors.white, fontSize: 13, letterSpacing: 0.1),
